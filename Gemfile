...
group :development do
  ...
  # The static local pilot disables reloading and does not expose the development debugger.
  gem 'tidewave', require: ENV['JRC_NICO_LOCAL_STATIC'] == 'true' ? false : 'tidewave'
end
