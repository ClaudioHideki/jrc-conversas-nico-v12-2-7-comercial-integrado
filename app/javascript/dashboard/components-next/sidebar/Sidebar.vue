  ...
  return [
    ...
    conversationModule
      ? {
          ...
          label: 'Conversas',
          to: accountScopedRoute('home'),
          children: (conversationModule.children || []).filter(
